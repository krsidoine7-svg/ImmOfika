...
export const metadata = {
  ...
  description: "Consultez la politique de confidentialité d'ImmOfika.",
}
  ...
  return (
    <>
      ...
      <main id="confidentiality-main" className="min-h-screen bg-[#F8F6F1] pt-24">
        {/* Hero Section */}
        <section id="confidentiality-hero" className="bg-slate-900 py-16 px-4 relative overflow-hidden">
          ...
          <div className="bg-white rounded-3xl p-8 md:p-12 border border-slate-100 shadow-xl space-y-12">
            ...
            <article id="confidentiality-retention" className="space-y-4">
              ...
              <div className="text-slate-600 space-y-2 text-sm md:text-base leading-relaxed font-medium">
                <p>
                  Nous ne conservons vos données que pour la durée strictly nécessaire à l&apos;accomplissement des finalités pour lesquelles elles ont été collectées :
                </p>
            ...
            <article id="confidentiality-cancellation" className="space-y-4">
              ...
              <div className="text-slate-600 space-y-3 text-sm md:text-base leading-relaxed font-medium">
                <p>
                  En sa qualité de <strong>Promoteur Immobilier Agréé par l&apos;État de Côte d&apos;Ivoire</strong>, ImmOfika applique les règles suivantes en cas d&apos;annulation d&apos;une réservation immobilière :
                </p>
                <ul className="list-disc pl-5 space-y-2 mt-2">
                  <li><strong>Acompte initial de 10% non remboursable :</strong> Le versement d&apos;acompte initial (minimum 10% du prix total du bien) effectué lors de la réservation est définitivement acquis à la société ImmOfika à titre d&apos;indemnité forfaitaire non remboursable. Cet acompte couvre les frais d&apos;instruction du dossier, les vérifications foncières, le temps de blocage du bien et les démarches administratives.</li>
            ...
            <article id="confidentiality-rights" className="space-y-4">
              <div className="flex items-center gap-3 text-slate-900 border-b border-slate-100 pb-3">
                <UserCheckIcon className="h-6 w-6 text-emerald-600" />
                <h2 className="text-xl md:text-2xl font-bold">6. Quels sont vos droits ?</h2>
              </div>
              <div className="text-slate-600 space-y-3 text-sm md:text-base leading-relaxed font-medium">
                <p>
