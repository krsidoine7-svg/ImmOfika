...
description: >-
  ...
  Intégré à Chefskrsidoine7 : délégation via mermaid-diagram-specialist, cartographie
...
**Intégration Chefskrsidoine7 :** lire [references/chefskrsidoine7-integration.md](references/chefskrsidoine7-integration.md) pour la délégation, les 6 sous-agents et les déclencheurs (brainstorming, fonctionnalités, workflows, onboarding, UX).
...
| [references/chefskrsidoine7-integration.md](references/chefskrsidoine7-integration.md) | Délégation manager, 6 sous-agents |
...
- **Chefskrsidoine7** — cartographie d'impact, délégation, validation avant exécution (voir [chefskrsidoine7-integration.md](references/chefskrsidoine7-integration.md)).
...
## Délégation Chefskrsidoine7

Ce skill est invoqué par **Chefskrsidoine7** via le sous-agent `mermaid-diagram-specialist`. Les 5 autres sous-agents sollicitent une visualisation **uniquement** après validation du manager.

| Étape | Responsable | Action |
|-------|-------------|--------|
| 1 | Chefskrsidoine7 | Cartographie d'impact — la viz est-elle nécessaire ? |
| 2 | Chefskrsidoine7 | Brief structuré → `mermaid-diagram-specialist` + ce skill |
| 3 | mermaid-diagram-specialist | Workflow 5 phases ([workflow.md](references/workflow.md)) |
| 4 | Chefskrsidoine7 | Validation et assemblage du livrable |

Détails, matrice des 6 sous-agents et exemples : [references/chefskrsidoine7-integration.md](references/chefskrsidoine7-integration.md).
