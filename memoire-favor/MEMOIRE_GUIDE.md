...
### Faire une Radiographie d'Impact (Indispensable)
Avant toute modification de code, l'IA doit :
1. Analyser les fichiers impactés via `ARCHITECTURE.md`.
2. Lister les risques de régressions.
3. Proposer un plan en 3 étapes.
C'est le protocole de **Radiographie d'Impact**.
...
| **Workflow Git & Radio** | `wiki/bonnes-pratiques/workflow-git.md` |
| **Soft Delete & Patterns DB** | `wiki/bonnes-pratiques/patterns-db.md` |
